...
public class VoiceSpeaker : MonoBehaviour
{
    ...
    public static string NumbersName = "AsemEng/Numbers";
    public static string voiceClipsName = "AsemEng/Numbers";
    public static string MinusPlace = "SolvingTwoEqs/minus_Sonya_Eng";
    public static string PointPlace = "AsemEng/point";
    ...
    public static IEnumerator PlayVoiceNumberAndWait(String text)
    {
        if (text.Length >= 1) {
            ...
            if (text[0].Equals('-'))
            {
                AudioClip MinusAudioClip = Resources.Load<AudioClip>(MinusPlace);
            ...
            else
            {
                ...
                else
                {
                    ...
                    audioSource.Play();
                    yield return new WaitForSeconds(audioSource.clip.length);
                    AudioClip PointClip = Resources.Load<AudioClip>("SolvingTwoEqs/POINT_Sonya_Eng");
