...
public class AdditionEng : MonoBehaviour, TwoEqsParent
{
    ...
    public AdditionEng(GameObject Circle, GameObject Arrow, TMP_InputField X1, TMP_InputField Y1, TMP_InputField Res1, TMP_InputField X2, TMP_InputField Y2, TMP_InputField Res2, ref TextMeshProUGUI Answer, ref TextMeshProUGUI lineRenderer)
    {
        this.Circle = Circle;
        this.Arrow = Arrow;
        this.X1 = X1;
    ...
    public void Solve()
    {
        ...
        Answer.text += "   " + (X1Val + X2Val) + "x = " +" "+ (ResFloat1+ResFloat2)+'\n';
        Answer.text += "   x = " + (ResFloat1+ResFloat2) + " ÷ " + (X1Val+X2Val) + '\n';
        Answer.text += $"<color=#{UnityEngine.ColorUtility.ToHtmlStringRGB(Color.gray)}>{"              x = " + (ResFloat1 + ResFloat2) /(X1Val+X2Val)}</color>" + '\n';
        ...
        if ((X2Val * X2Val) > 0)
            ...
            Answer.text += "   " + Y2Val.ToString() + "y " + " = " + ResFloat2 + " + " + Mathf.Abs(X2Val * XFinalResult) + "\n";
